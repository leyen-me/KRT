...
*/
-- AlterTable
ALTER TABLE `SysDictItem` ADD COLUMN `sort` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `variant` ENUM('DEFAULT', 'DESTRUCTIVE', 'OUTLINE', 'SECONDARY', 'GHOST', 'LINK') NOT NULL DEFAULT 'SECONDARY';
